...
python3 generate_event_pages.py "$git_repo_root_dir/docs/references/device-api/v0.2.1/api.yaml" "$git_repo_root_dir/docs/references/device-api/v0.2.1/events"
