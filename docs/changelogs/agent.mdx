...
`v0.8.0` adds YAML support and Server-Sent Events (SSE) streaming to the Miru Agent. On-device applications can now receive real-time deployment lifecycle notifications. This release also upgrades the Device API to [v0.2.1](/docs/changelogs/device-api#v0-2-1).
