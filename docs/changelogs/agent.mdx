...
<Update label="Unreleased">
    ...
    `v0.7.0` upgrades the Miru Agent to Device API [v0.2.0](/docs/changelogs/device-api#v020), adding deployment-pipeline visibility for on-device applications and improving deployment reliability under transient failures.

    [Device API migration guide »](/docs/changelogs/device-api#v020)

    ### Breaking changes

    - Upgraded to Device API `v0.2.0`, visit the [v0.2.0 changelog](/docs/changelogs/device-api#v020) for more details
