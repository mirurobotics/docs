...
[Device API v0.2.1 changelog »](/changelogs/device-api#v0-2-1)
...
`v0.7.0` upgrades the Miru Agent to Device API [v0.2.0](/changelogs/device-api#v0-2-0), adding deployment-pipeline visibility for on-device applications and improving deployment reliability under transient failures.

[Device API migration guide »](/changelogs/device-api#v0-2-0)

## Breaking changes

- Upgraded to Device API `v0.2.0`, visit the [v0.2.0 changelog](/changelogs/device-api#v0-2-0) for more details
...
[Read the full documentation »](/learn/devices/provision#poor-connectivity)
