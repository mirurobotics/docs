...
<Dropdown title="Miru-Version header">
  The `Miru-Version` header is now supported. The header is optional and defaults to the latest supported version (`2026-03-09.tetons`) when omitted.
...
<Warning>
  The `2025-10-21.zion` API version has reached **end of life** and is no longer supported. Requests to this API version will return a `400 Bad Request` error. Please migrate to `2026-03-09.tetons`. See the [migration steps](#migration-steps) above.
</Warning>
