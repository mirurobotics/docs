...
<Dropdown title="Device expansions: current_release and current_deployment">
  ...
  - Device responses gain a new subschema for the expandable fields. The same subschema is also embedded in `device` objects nested inside deployment responses.
