...
<Update label="March 13, 2026">
    ...
    For a detailed list of changes, visit the [Platform API changelog](/changelogs/platform-api#2026-03-09-tetons).
    ...
    For a detailed list of changes, visit the [Device API changelog](/changelogs/device-api#v0-2-0).
