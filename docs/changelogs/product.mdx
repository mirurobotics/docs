...
<Update label="April 10, 2026">
    ...
    [Read about Agent SSE »](/docs/developers/device-api/events)
...
<Update label="March 23, 2026">
    ...
    [Read the full documentation »](/docs/learn/releases/staging-area#stage-a-deployment)
...
<Update label="March 13, 2026">
    ...
    For a detailed list of changes, visit the [Platform API changelog](/docs/changelogs/platform-api#2026-03-09-tetons).

    <img src="https://assets.mirurobotics.com/docs/changelog/26-03-13/platform-api.png" style={{ borderRadius: '8px' }} />

    [Platform API Documentation »](/docs/developers/platform-api/overview)
    ...
    For a detailed list of changes, visit the [Device API changelog](/docs/changelogs/device-api#v0-2-0).

    <img src="https://assets.mirurobotics.com/docs/changelog/26-03-13/device-api.png" style={{ borderRadius: '8px' }} />

    [Device API Documentation »](/docs/developers/device-api/overview)
    ...
    [Miru Agent Documentation »](/docs/developers/agent/overview)
