...
The `instance_filepath` annotation has been updated to be an absolute filesystem path instead of a relative path to `/srv/miru/config_instances/`. Update all schema annotations:
