...
API Reference: <LinkNewTab href="/docs/references/device-api/v0.2.0">v0.2.0 Reference</LinkNewTab>
...
API Reference: <LinkNewTab href="/docs/references/device-api/v0.1.0">v0.1.0 Reference</LinkNewTab>
