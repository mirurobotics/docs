...
<Steps>
  <Step title="Verify agent compatibility">
    Ensure all devices in your fleet are running **Miru Agent v0.7.0** or later. See the [agent compatibility matrix](/docs/developers/device-api/versions#agent-compatibility-matrix) for details.
  </Step>
