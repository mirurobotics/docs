...
<Frame>
  ![Miru UI screenshot](/images/users/profile/main.png)
</Frame>
...
<Frame>
  ![Miru UI screenshot](/images/users/profile/set-avatar-dropdown.png)
</Frame>

Select the image you want to use from the file system. A dialog will appear, allowing you to crop the image.

<Frame>
  ![Miru UI screenshot](/images/users/profile/crop-avatar.png)
</Frame>
...
<Frame>
  ![Miru UI screenshot](/images/users/profile/remove-avatar-dropdown.png)
</Frame>
