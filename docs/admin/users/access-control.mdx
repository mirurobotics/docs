...
There are a variety of privileges which are only available to owners and administrators. Outside of [group manager](#manager), no roles can grant these privileges.
