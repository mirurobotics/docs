...
[Groups](/fundamentals/groups/overview)
- Create a group
- Update a group
- Delete a group
...
[Releases](/fundamentals/releases/manage)
- Delete a release
...
- **Group roles** apply to a [group](/fundamentals/groups/overview) and all of its subgroups
...
- [Create a release](/cfg-mgmt/releasing-config-schemas)
- [Duplicate a release](/fundamentals/releases/manage#duplicate-a-release)
...
[Manage devices](/fundamentals/devices/manage)

- Create a device
- Edit a device
- Delete a device

[Provision devices](/fundamentals/devices/provision/dashboard)
...
[Devices](/fundamentals/devices/manage)

- Move a device to a different group

[Members](/fundamentals/groups/members)
