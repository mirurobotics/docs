...
[Config types](/cfg-mgmt/concepts/config-types)
- Delete a config type

[Groups](/concepts/groups/manage)
- Create a group
- Update a group
- Delete a group
...
- **Group roles** apply to a [group](/concepts/groups/overview) and all of its subgroups
...
- Edit a config type
- Archive a config type
- Unarchive a config type

[Config schemas](/cfg-mgmt/concepts/schemas/manage)

- Create a config schema

[Buckets](/data-uploads/concepts/buckets)
...
[Upload collections](/data-uploads/concepts/upload-collections)
...
[Manage devices](/concepts/devices/manage)

- Create a device
- Edit a device
- Delete a device

[Provision devices](/provision-devices/dashboard)
...
[Devices](/concepts/devices/manage)

- Move a device to a different group

[Members](/concepts/groups/members)
