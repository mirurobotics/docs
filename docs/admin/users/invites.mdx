...
To revoke an invite, navigate click the **n pending** invites button in the top right.
...
Finally, confirm the deletion by clicking **Revoke** in the confirmation dialog.
...
To resend an invite, navigate click the **n pending** invites button in the top right.
