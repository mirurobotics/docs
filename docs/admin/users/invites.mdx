...
<Framed background="/images/users/background.jpeg" image="/images/invites/header:join-workspace.png" borderWidth="40px" />
...
<Frame>
  ![Miru UI screenshot](/images/invites/send-dialog.png)
</Frame>
...
<Frame>
  ![Miru UI screenshot](/images/invites/dropdown.png)
</Frame>
...
<Frame>
  ![Miru UI screenshot](/images/users/profile/invitations.png)
</Frame>

Finally, click **Join workspace** to accept the invite and transfer workspaces.

<Frame>
  ![Miru UI screenshot](/images/users/profile/accept-invite-dialog.png)
</Frame>
