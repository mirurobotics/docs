...
<Framed 
background="https://assets.mirurobotics.com/docs/v04/images/apikeys/background.jpeg" 
image="https://assets.mirurobotics.com/docs/v04/images/apikeys/header:page.png" 
borderWidth="28px"
innerRadius="10px"
outerRadius="12px"
/>
...
<Frame>
  ![Create API Key Dialog](/images/apikeys/create-dialog.png)
</Frame>
...
<Frame>
  ![API Key Ellipses Dropdown](/images/apikeys/ellipses-dropdown.png)
</Frame>

A confirmation dialog will appear. Hit **Delete** to confirm the deletion.

<Frame>
  ![API Key Delete Dialog](/images/apikeys/delete-dialog.png)
</Frame>
