...
Miru supports continuous integration (CI) to automate various tasks, such as the creation of [releases](/cfg-mgmt/releasing-config-schemas) and their associated schemas.
