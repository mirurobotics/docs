...
Miru supports continuous integration (CI) to automate various tasks, such as the creation of [releases](/cfg-mgmt/defining-releases) and their associated schemas.
