...
For a comprehensive guide on creating releases, visit the [create releases](/cfg-mgmt/releasing-config-schemas) documentation. For a concise reference of the CLI command, visit the [CLI Reference](/references/cli/release-create).
