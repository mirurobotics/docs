...
For a comprehensive guide on creating releases, visit the [create releases](/cfg-mgmt/defining-releases) documentation. For a concise reference of the CLI command, visit the [CLI Reference](/references/cli/release-create).
