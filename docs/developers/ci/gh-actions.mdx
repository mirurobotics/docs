...
You can find the CLI changelog in the [CLI changelog](/changelogs/cli).
...
For a comprehensive guide on creating releases, visit the [create releases](/learn/releases/create) documentation. For a concise reference of the CLI command, visit the [CLI Reference](/references/cli/release-create).
