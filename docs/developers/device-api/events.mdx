...
The agent sends SSE comment lines approximately every 30 seconds to keep the connection alive and prevent proxies or firewalls from closing idle connections. 
