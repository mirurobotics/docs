...
The Device API adheres to [semantic versioning](https://semver.org/), which was chosen to allow on-device applications to easily determine API version compatibility.
...
|-------------|--------------|--------------------|
| <LinkNewTab href="/docs/references/device-api/v0.2.0">v0.2.0</LinkNewTab>    | TBD          | <SupportedBadge /> |
| <LinkNewTab href="/docs/references/device-api/v0.1.0">v0.1.0</LinkNewTab>    | 2025-09-21   | <DeprecatedBadge />|
...
<CardNewTab
  href="/docs/changelogs/device-api"
  title="Device API Changelog"
  icon="scroll-text"
  arrow
>
...
Each version of the spec is available for download as a YAML file from the [Device API changelog](/docs/changelogs/device-api). Use the specs to generate client code, validate requests, or import into tools like Postman and Swagger UI.
