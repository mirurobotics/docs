...
Each version of the spec is available for download as a YAML file from the [Device API changelog](/changelogs/device-api). Use the specs to generate client code, validate requests, or import into tools like Postman and Swagger UI.
