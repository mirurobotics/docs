...
<Warning>
  The `v0.1.0` API version uses the legacy [python-agent-sdk](https://github.com/mirurobotics/python-agent-sdk) repository and the `miru_agent_sdk` import path. See <LinkNewTab href="/changelogs/device-api#v0-1-0">changelog</LinkNewTab>.
</Warning>
...
If you're using a language not yet supported by an official SDK, you can still generate client code from the OpenAPI specification. All OpenAPI specifications are available for download from the <LinkNewTab href="/changelogs/device-api">Device API Changelog</LinkNewTab> page.
