...
To verify your credentials and check which principal your API key authenticates as, use the <PlatformApiLink endpoint="principals/self">self endpoint »</PlatformApiLink>
