...
For historical reasons, omitting the `Miru-Version` header defaults to the oldest supported version, which is `2025-10-21.zion`.
...
| API Version              |        Status       |
|--------------------------|---------------------|
| <LinkNewTab href="/docs/references/platform-api/2026-03-09">2026-03-09.tetons</LinkNewTab> | <SupportedBadge />  |
| <LinkNewTab href="/docs/references/platform-api/2025-10-21">2025-10-21.zion</LinkNewTab>        | <DeprecatedBadge />  |
