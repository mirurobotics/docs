...
| <LinkNewTab href="/references/platform-api/2025-10-21">2025-10-21.zion</LinkNewTab>        | <EndOfLifeBadge />  |
...
Each version of the spec is available for download as a YAML file from the [Platform API changelog](/changelogs/platform-api). Use the specs to generate client code, validate requests, or import into tools like Postman and Swagger UI.
