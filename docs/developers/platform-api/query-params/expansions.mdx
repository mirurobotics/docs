...
For example, a [config instance](/docs/references/platform-api/latest/endpoints/config-instances/get) has the following default response structure:
...
- First, fetch the [**config instance**](/docs/references/platform-api/latest/endpoints/config-instances/get) using its ID (assuming you already know it).
- Then, having obtained the **`device_id`** from the config instance response, fetch the [**device**](/docs/references/platform-api/latest/endpoints/devices/get) using the device ID.
...
When listing config instances, you can expand fields in the same way you would for a single config instance. By default, [listing config instances](/docs/references/platform-api/latest/endpoints/config-instances/list) returns the following response structure.
