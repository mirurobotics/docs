...
The agent's identity is bound to the RSA key pair generated on-device during [provisioning](/docs/learn/devices/provision/overview). Currently, these credentials are protected at rest through file system permissions:
