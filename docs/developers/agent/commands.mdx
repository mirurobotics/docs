...
<Tabs >
  <Tab title="Active">
    ...
    <Frame>
      ![Miru UI screenshot](https://assets.mirurobotics.com/docs/v03/images/agent/commands/systemctl-status:running.png)
    </Frame>
  </Tab>
  <Tab title="Inactive">
    ...
    <Frame>
      ![Miru UI screenshot](https://assets.mirurobotics.com/docs/v03/images/agent/commands/systemctl-status:dead.png)
    </Frame>
  </Tab>
</Tabs>
