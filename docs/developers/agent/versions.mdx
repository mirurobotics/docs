...
To see the agent version currently installed on a device from the dashboard, visit the [Devices](/essentials/devices/overview) page and find the device you're interested in. The agent version is displayed in the **Agent** field.
