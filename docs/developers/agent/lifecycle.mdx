...
To check the agent version from the server-side API, query the <LinkNewTab href="/docs/references/server-side-api/latest/endpoints/devices/list#query-parameters">list devices</LinkNewTab> endpoint and <LinkNewTab href="/docs/developers/server-side-api/query-params/filtering">filter</LinkNewTab> by the `agent_version` field.
