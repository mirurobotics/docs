...
[file rule](/data-uploads/primitives/file-rules)'s `source.glob` and streams them to
...
If a file rule has a [`retention`](/data-uploads/primitives/file-rules#retention) block,
