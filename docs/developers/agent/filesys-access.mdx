...
[file rule's](/data-uploads/primitives/file-rules/overview) `source.glob` and streams them to
...
If a file rule has a [`retention`](/data-uploads/primitives/file-rules/rule-definition#retention) block,
