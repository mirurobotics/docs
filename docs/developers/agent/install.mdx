...
It does not cover provisioning devices for your workspace. Visit the [device provisioning](/docs/learn/devices/provision/overview) documentation to learn how to create and register devices with your workspace.
...
<Warning>
    If you're upgrading from a `miru-agent` version that precedes `v0.9.0` to `v0.9.0` or later, you MUST [reprovision](/docs/learn/devices/provision/reprovision) the device after upgrading the `miru-agent` package.
</Warning>
