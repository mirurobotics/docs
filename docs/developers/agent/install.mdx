...
<Warning>
    If you're upgrading to a `miru-agent` version that precedes `v0.9.0`, you MUST [reprovision](/docs/learn/devices/provision/reprovision) the device after upgrading the `miru-agent` package.
</Warning>
