...
<Warning>
    If you're upgrading from a `miru-agent` version that precedes `v0.9.0` to `v0.9.0` or later, you MUST [reprovision](/learn/devices/provision/reprovision) the device after upgrading the `miru-agent` package.
</Warning>
