...
It does not cover provisioning devices for your workspace. Visit the [device provisioning](/cfg-mgmt/provision-devices/overview) documentation to learn how to create and register devices with your workspace. To install the agent and provision a fleet together, use the [Ansible](/cfg-mgmt/provision-devices/ansible) collection.
