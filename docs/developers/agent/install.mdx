...
It does not cover provisioning devices for your workspace. Visit the [device provisioning](/essentials/devices/provision/overview) documentation to learn how to create and register devices with your workspace.
...
<Danger>
    [Provisioning tokens](/essentials/devices/provision/provisioning-tokens) require Miru Agent `v0.9.0` or later. If you are running a version that precedes `v0.9.0`, use the legacy [provisioning script](/essentials/devices/provision/provisioning-script) to provision instead.
</Danger>
