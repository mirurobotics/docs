...
<Tabs>
  ...
  <Tab title="Linux">
    You can upgrade the CLI via `apt` or manually by downloading and installing the new package. Since both methods use Debian packages, manual installations can be upgraded via `apt` and vice versa.
