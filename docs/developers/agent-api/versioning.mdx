...
The Agent API is defined using the OpenAPI 3.0 specification. 

Each version of the spec is available for download as a YAML file from the [Agent API changelog](/docs/changelogs/agent-api). Use the specs to generate client code, validate requests, or import into tools like Postman and Swagger UI.
