...
- The legacy provisioning script only supports provisioning `miru-agent` versions that precede `v0.9.0`; use [provisioning tokens](/learn/devices/provision/provisioning-tokens) for `miru-agent` versions `v0.9.0` or later
