...
Reading files for upload may require granting the `miru` user [read access](/developers/agent/filesys-access#read-only) to the source paths. To learn more, visit the [data uploads](/data-uploads/overview) documentation.
...
To learn more, visit the [file system access](/developers/agent/filesys-access#read-and-write) documentation.
