...
<div className="changelog-page">
  ...
  <Update label="August 14, 2026">
    ...
    **instance slots**. Each slot is a separate file system destination validated by the same schema.
    ...
    [File rules »](/data-uploads/primitives/file-rules/overview)
  ...
  <Update label="July 20, 2026">
    ...
    **Data Uploads** allows devices to upload files directly to a cloud storage bucket you own. First, define an [upload rule](/data-uploads/primitives/file-rules/overview), which specifies what files to collect and where to store them in your bucket. Then, the Miru Agent detects matching files on your devices and streams them straight to your bucket.
