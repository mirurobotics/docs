...
<Update label="August 14, 2026">
    ...
    **instance slots**. Each slot is a separate file system destination validated by the same schema. 
    ...
    <Framed
        ...
        background="https://assets.mirurobotics.com/docs/changelog/26-08-14/background.jpg"
        borderWidth="24px 0px 0px 24px"
        innerRadius="8px 0px 0px 0px"
    />
    ...
    The `retention` configuration for a file rule added a `ttl_secs` field, which allows you to specify how long a file should be retained on disk before being deleted.
    ...
    <Framed
        image="https://assets.mirurobotics.com/docs/changelog/26-08-14/file-rule.png"
        background="https://assets.mirurobotics.com/docs/changelog/26-08-14/background.jpg"
    />
    ...
    <Dropdown title="Improvements">
        <DropdownItem>
            **Draft Mode Shows Diffs:** The draft mode now shows diffs between old values and new values while you're editing a config.
        </DropdownItem>
        <DropdownItem>
            **Git Commit Message Truncation:** Uploaded git commit messages are now automatically truncated to 2KB instead of throwing an error for messages longer than 2KB.
        </DropdownItem>
    </Dropdown>
...
<Update label="July 20, 2026">
    ...
    **Data Uploads** allows devices to upload files directly to a cloud storage bucket you own. First, define an [upload rule](/data-uploads/primitives/file-rules), which specifies what files to collect and where to store them in your bucket. Then, the Miru Agent detects matching files on your devices and streams them straight to your bucket.
    ...
    <Framed
        image="https://assets.mirurobotics.com/docs/changelog/26-07-23/upload-rule.png"
        background="https://assets.mirurobotics.com/docs/changelog/26-07-23/background.jpg"
        innerRadius="8px"
    />
    ...
    <Framed
        image="https://assets.mirurobotics.com/docs/changelog/26-07-23/bucket-page.png"
        background="https://assets.mirurobotics.com/docs/changelog/26-07-23/background.jpg"
        innerRadius="8px"
    />
...
<Update label="May 27, 2026">
    ...
    <Framed
        image="https://assets.mirurobotics.com/docs/changelog/26-05-27/grp.png"
        borderWidth="0px"
        innerRadius="8px"
    />
    ...
    <Framed
        image="https://assets.mirurobotics.com/docs/changelog/26-05-27/settings.png"
        borderWidth="0px"
        innerRadius="8px"
    />
...
<Update label="May 12, 2026">
    ...
    <Framed
        image="https://assets.mirurobotics.com/docs/changelog/26-05-12/apt-repo-install.png"
        background="https://assets.mirurobotics.com/docs/changelog/26-05-12/background.jpg"
        innerRadius="8px"
    />
    ...
    <Framed
        image="https://assets.mirurobotics.com/docs/changelog/26-05-12/provision-dialog.png"
        background="https://assets.mirurobotics.com/docs/changelog/26-05-12/background.jpg"
        innerRadius="8px"
        borderWidth="18px"
    />
