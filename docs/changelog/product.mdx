...
<Update label="June 23, 2026">
    ...
    **user type** that sets their baseline access, plus **roles** that are applied 
    ...
    [Manage group members »](/essentials/groups/members)
...
<Update label="May 27, 2026">
    ...
    [Groups Documentation »](/essentials/groups/overview)
...
<Update label="May 12, 2026">
    ...
    Device provisioning has been rebuilt around provisioning tokens, replacing the legacy [provisioning script](/essentials/devices/provision/provisioning-script) workflow. Provisioning tokens are short-lived (5-minute), single-use credentials that can both create and activate devices for your workspace. 
    ...
    [Device Provisioning Documentation »](/essentials/devices/provision/overview)
