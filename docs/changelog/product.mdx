...
<Update label="June 23, 2026">
    ...
    **user type** that sets their baseline access, plus **roles** that are applied 
    ...
    [Manage group members »](/fundamentals/groups/members)
...
<Update label="May 27, 2026">
    ...
    [Groups Documentation »](/fundamentals/groups/overview)
...
<Update label="May 12, 2026">
    ...
    Device provisioning has been rebuilt around provisioning tokens, replacing the legacy [provisioning script](/fundamentals/devices/provision/provisioning-script) workflow. Provisioning tokens are short-lived (5-minute), single-use credentials that can both create and activate devices for your workspace. 
    ...
    [Device Provisioning Documentation »](/fundamentals/devices/provision/overview)
...
<Update label="January 27, 2026">
    ...
    [Read the full documentation »](/cfg-mgmt/releasing-config-schemas)
    ...
    [Read the full documentation »](/cfg-mgmt/releasing-config-schemas#cue-packages)
...
<Update label="December 4, 2025">
    ...
    [Read the full documentation »](/cfg-mgmt/schemas/languages/overview)
