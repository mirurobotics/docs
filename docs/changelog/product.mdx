...
<Update label="May 27, 2026">
    ...
    [Groups Documentation »](/learn/groups/overview)
    ...
    [Editor settings documentation »](/learn/devices/config-editor#editor-settings)
...
<Update label="May 12, 2026">
    ...
    Device provisioning has been rebuilt around provisioning tokens, replacing the legacy [provisioning script](/learn/devices/provision/provisioning-script) workflow. Provisioning tokens are short-lived (5-minute), single-use credentials that can both create and activate devices for your workspace. 
