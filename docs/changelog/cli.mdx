...
`v0.7.0` is the first CLI release with [CUE](/cfg-mgmt/schemas/languages/overview) support. You can now push CUE-based schemas directly and use CUE alongside existing JSON Schema workflows.
