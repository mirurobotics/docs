...
- Add support for the [instance slots](/cfg-mgmt/concepts/schemas/instance-slots) schema annotation, letting one config schema write config instances to several file paths
