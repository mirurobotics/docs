...
<ParamField path="glob" type="string" required>
  ...
  <Warning>
    You must grant the Miru Agent read access to the files you want to upload. Visit the [file system access](/developers/agent/filesys-access#read-only) section for more details.
  </Warning>
