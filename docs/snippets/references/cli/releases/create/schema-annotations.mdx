...
<ParamField path="instance slots">
  ...
  For more information about instance slots, visit the [Instance slots](/cfg-mgmt/concepts/schemas/overview#instance-slots) section of the schemas documentation.
