...
<ParamField path="instance file path">
  ...
  <Warning>
    The Miru Agent ships with out-of-the-box access to `/srv/miru`. To deploy configurations to a custom directory, please visit the [File Permissions](/developers/agent/file-permissions) page.
  </Warning>
