...
<ParamField path="--upload-rules" type="string">
  A directory containing [upload rule](/data-uploads/releasing-upload-rules) YAML files to include in the release. May be specified multiple times for multiple directories. Only YAML files in the directory are picked up.
...
<ParamField path="--upload-rule" type="string">
  The path to an [upload rule](/data-uploads/releasing-upload-rules) YAML file to include in the release. May be specified multiple times to include multiple rules.
