...
<ParamField path="--file-rules" type="string">
  A directory containing [file rule](/data-uploads/primitives/file-rules/rule-definition#file-format) YAML files to include in the release. May be specified multiple times for multiple directories. Only YAML files in the directory are picked up.

  Examples: `./file-rules/`
</ParamField>

<ParamField path="--file-rule" type="string">
  The path to a [file rule](/data-uploads/primitives/file-rules/rule-definition#file-format) YAML file to include in the release. May be specified multiple times to include multiple rules.
