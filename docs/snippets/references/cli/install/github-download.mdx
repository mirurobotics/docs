...
<Frame>
  <img src="https://assets.mirurobotics.com/docs/v03/images/cli/github-assets.light.png" alt="GitHub release assets" className="block dark:hidden" />
  <img src="https://assets.mirurobotics.com/docs/v03/images/cli/github-assets.dark.png" alt="GitHub release assets" className="hidden dark:block" />
</Frame>
