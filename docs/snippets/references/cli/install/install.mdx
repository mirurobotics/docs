...
The CLI is only available on macOS and Linux. Windows is not supported; on Windows, use [WSL 2](https://learn.microsoft.com/windows/wsl/install) and follow the Linux instructions.
