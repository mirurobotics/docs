...
<Frame>
  ![Release Ellipses Dropdown](https://assets.mirurobotics.com/docs/v04/images/releases/active-ellipses-dropdown.png)
</Frame>
...
Archiving a release hides it from the releases list and restricts deployments to *only* devices currently running that release.

New devices cannot be deployed with an archived release and existing devices cannot switch to or rollback to an archived release.

Archiving a release retains its config schemas and deployment history, and releases can be unarchived at any time.

To archive a release, click the ellipses (...) on the release and select **Archive**.

<Frame>
  ![Archive Release Ellipses Dropdown](https://assets.mirurobotics.com/docs/v04/images/releases/active-ellipses-dropdown.png)
</Frame>

A dialog will appear. Hit **Archive** to confirm the archive.

<Frame>
  ![Archive Release Dialog](https://assets.mirurobotics.com/docs/v04/images/releases/archive-dialog.png)
</Frame>
...
Unarchiving a release makes it available for any device to deploy from it again.

Find the release among the archived releases, click the ellipses (...), and select **Unarchive**.

<Frame>
  ![Unarchive Release Ellipses Dropdown](https://assets.mirurobotics.com/docs/v04/images/releases/archived-ellipses-dropdown.png)
</Frame>

A dialog will appear. Hit **Unarchive** to confirm the unarchive.

<Frame>
  ![Unarchive Release Dialog](https://assets.mirurobotics.com/docs/v04/images/releases/unarchive-dialog.png)
</Frame>
