...
<ParamField path="id" type="string">
  ...
  The deployment's unique identifier. The dashboard shows a short form: `DPL-` plus the
  first five characters after `dpl_`. The CLI and Platform API take the full ID.
