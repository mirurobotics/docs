...
You define a small set of [**file rules**](/data-uploads/primitives/file-rules/overview) — what to
...
held steady for the rule's [`stability_window_secs`](/data-uploads/primitives/file-rules/rule-definition#sources)
...
path](/data-uploads/primitives/file-rules/rule-definition#uploads): it must include the `{upload_id}` variable somewhere in the template.
