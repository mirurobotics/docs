...
collect, when it is considered finished, and, for the rules that upload, where it goes. The
...
path](/data-uploads/primitives/file-rules): it must include the `{upload_id}` variable somewhere in the template. 
