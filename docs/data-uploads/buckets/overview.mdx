...
<ParamField path="config" type="Bucket Config">
  ...
  [GCS](/data-uploads/buckets/connect/gcs); for `aws`, see [AWS](/data-uploads/buckets/connect/aws).
</ParamField>

## Connect a bucket  <PublisherBadge />

To connect a bucket, visit the [Connect buckets](/data-uploads/buckets/connect) page.
...
<Frame>
  ![Bucket Ellipsis Dropdown](/images/buckets/ellipsis-dropdown.png)
</Frame>

Update the desired fields, then click **Save**.

<Frame>
  ![Bucket Edited](/images/buckets/edit-dialog.png)
</Frame>
...
<Frame>
  ![Bucket Deleted](/images/buckets/delete-dialog.png)
</Frame>
...
<Frame>
  ![Bucket Archived](/images/buckets/archive-dialog.png)
</Frame>
