...
Upload collections are created automatically when you create an upload rule. Visit the [define releases](/data-uploads/releases/define) page to learn how to create upload collections and upload rules.
