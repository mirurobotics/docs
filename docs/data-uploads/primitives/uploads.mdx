...
Once a [file rule](/data-uploads/primitives/file-rules/overview) with an `upload` block is
...
<ParamField path="file rule" type="File Rule">
  ...
  The [file rule](/data-uploads/primitives/file-rules/overview) that produced the upload.
</ParamField>
...
<ParamField path="file_path" type="string">
  ...
  variable in the [upload path template](/data-uploads/primitives/file-rules/rule-definition#uploads).
