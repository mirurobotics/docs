...
[releasing them via the CLI](/data-uploads/release-upload-rules).
...
See [defining releases](/data-uploads/release-upload-rules) for more information about a particular field.
...
[releasing them via the CLI](/data-uploads/release-upload-rules). Each rule records the
...
Upload rules must be created as part of a [release](/primitives/releases). Visit the [define releases](/data-uploads/release-upload-rules) page to learn how to create upload rules and releases.
