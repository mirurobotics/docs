...
[releasing them via the CLI](/data-uploads/create-a-release).
...
See [defining releases](/data-uploads/create-a-release) for more information about a particular field.
...
[releasing them via the CLI](/data-uploads/create-a-release). Each rule records the
...
Upload rules must be created as part of a [release](/primitives/releases). Visit the [define releases](/data-uploads/create-a-release) page to learn how to create upload rules and releases.
