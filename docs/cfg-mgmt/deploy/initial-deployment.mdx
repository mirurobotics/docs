...
Only devices that have been [provisioned](/fundamentals/devices/provision/overview), but never deployed to, are candidates for an initial deployment.
...
<Note>
  ...
  [create a release](/cfg-mgmt/releasing-config-schemas) before
  continuing.
</Note>
