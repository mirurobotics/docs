...
<Frame>
  ![Context Menu](https://assets.mirurobotics.com/docs/v04/images/devices/editor/history-context-menu.png)
</Frame>
...
<Frame>
  ![Deployment Alert](https://assets.mirurobotics.com/docs/v04/images/devices/editor/depl-alert.png)
</Frame>  
