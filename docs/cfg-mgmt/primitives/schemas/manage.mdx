...
Schemas must be created as part of a release. Visit the [define releases](/cfg-mgmt/defining-releases) page to learn how to create a release along with its schemas.
