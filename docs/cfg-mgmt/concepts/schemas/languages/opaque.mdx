...
Consult the [schema annotations](/cfg-mgmt/concepts/schemas/annotations/overview) documentation to learn more about what the individual fields mean and how to use them.
