...
Consult the [schema annotations](/cfg-mgmt/concepts/schemas/annotations) documentation to learn more about what the individual fields mean and how to use them.
