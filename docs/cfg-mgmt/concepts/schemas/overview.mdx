...
For the full list of annotations and their syntax in each schema language, visit the [annotations](/cfg-mgmt/concepts/schemas/annotations) section of this guide.
