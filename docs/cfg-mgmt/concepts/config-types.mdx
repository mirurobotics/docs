...
<Frame>
  ![Archive Config Type Dialog](https://assets.mirurobotics.com/docs/v04/images/config-types/archive-dialog.png)
</Frame>

## Unarchive a config type

Unarchiving removes the archive restrictions placed on it, allowing releases and schemas to be created with it again.
