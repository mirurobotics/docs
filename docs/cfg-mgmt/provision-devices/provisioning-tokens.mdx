...
Provisioning tokens are created via the [Platform API](/references/platform-api/2026-08-17/endpoints/provisioning-tokens/create) endpoint using [API keys](/admin/apikeys).
...
curl --request POST \
  ...
  --header 'Miru-Version: 2026-08-17.everglades' \
