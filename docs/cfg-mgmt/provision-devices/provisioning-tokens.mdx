...
- **Integrate with existing infrastructure** management tools and workflows. To install the agent and provision a fleet in one play, use the [Ansible](/cfg-mgmt/provision-devices/ansible) collection.
