...
The Miru dashboard is the simplest method for provisioning a device, ideal for getting started or managing individual devices. For automated provisioning, use [provisioning tokens](/cfg-mgmt/provision-devices/provisioning-tokens) or the official [Ansible collection](/cfg-mgmt/provision-devices/ansible).
