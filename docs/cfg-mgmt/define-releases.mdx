...
The primary method of creating releases is via the command line. The dashboard does not support creating new releases (although you can [duplicate existing releases](/essentials/releases/manage#duplicate-a-release)).
