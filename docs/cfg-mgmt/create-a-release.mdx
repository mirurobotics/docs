...
The only way to create releases is via the command line. The dashboard only supports [duplicating releases](/essentials/releases/manage#duplicate-a-release).
