...
Schemas must be created as part of a release. Visit the [create releases](/cfg-mgmt/releasing-config-schemas) page to learn how to create a release along with its schemas.
