...
<ParamField path="release" type="Release">
  ...
  The [release](/fundamentals/releases/overview#properties) which the deployment adheres to.
...
<ParamField path="config instances" type="[] Config Instance">
  ...
  The [config instances](/cfg-mgmt/config-instances#properties) in the deployment, each of which satisfies a different config schema in the deployment's release.
