...
<Frame>
  ![Config types page](/images/config-types/create-page.png)
</Frame>

Click the **New Config Type** button, supply the name `Mobility` and slug `mobility`, and click **Create**.

<Frame>
  ![Create config type dialog](/images/config-types/create-dialog.png)
</Frame>
...
<Frame>
  ![Release overview page](/images/releases/overview.png)
</Frame>
