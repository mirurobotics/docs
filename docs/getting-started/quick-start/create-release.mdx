...
If you're unfamiliar with schema languages, we recommend starting with [JSON Schema](/learn/schemas/languages/jsonschema). If you don't currently use a schema, we recommend starting with an empty schema and gradually adding constraints as needed.
...
For a more comprehensive guide on creating releases, visit the [create releases](/learn/releases/create) documentation. For a concise reference of the CLI command, visit the [CLI Reference](/references/cli/release-create).
