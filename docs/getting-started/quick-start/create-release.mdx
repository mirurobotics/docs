...
import InstallCLI from '/snippets/references/cli/install/install.mdx';
import LoginCLI from '/snippets/references/cli/login.mdx';
import SchemaAnnotations from '/snippets/references/cli/releases/create/schema-annotations.mdx';
...
<Frame>
  ![Miru UI screenshot](https://assets.mirurobotics.com/docs/v03/images/releases/overview.png)
</Frame>
