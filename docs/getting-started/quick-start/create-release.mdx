...
For a more comprehensive guide on creating releases, visit the [define releases](/cfg-mgmt/defining-releases) documentation. For a concise reference of the CLI command, visit the [CLI Reference](/references/cli/release-create).
