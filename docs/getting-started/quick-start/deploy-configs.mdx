...
This guide uses Linux file paths. Windows devices need config schemas with Windows file paths; see the [instance file path](/cfg-mgmt/concepts/schemas/annotations#param-instance-file-path) annotation.
