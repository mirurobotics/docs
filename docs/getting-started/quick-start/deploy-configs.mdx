...
<Frame>
  ![Miru UI screenshot](https://assets.mirurobotics.com/docs/v03/images/devices/one-device-to-provision.png)
</Frame>

Select the release we just created and hit **Next**.

<Frame>
  ![Miru UI screenshot](https://assets.mirurobotics.com/docs/v03/images/devices/editor/set-release-dialog-step1.png)
</Frame>

Input the desired parameters for the `Mobility`, `Planning`, and `Communication` config instances respectively.

<Frame>
  ![Miru UI screenshot](https://assets.mirurobotics.com/docs/v03/images/devices/editor/set-release-dialog-step2-edit.png)
</Frame>
...
<Frame>
  ![Miru UI screenshot](https://assets.mirurobotics.com/docs/v03/images/devices/editor/set-release-dialog-step2-description.png)
</Frame>
...
<Frame>
  ![Miru UI screenshot](https://assets.mirurobotics.com/docs/v03/images/devices/editor/history-entry.png)
</Frame>

The `File Path` field shows the absolute filesystem path where the config instance is written on the device.

Since the `File Path` is `/srv/miru/configs/mobility.json`, the config instance is written directly to that path on the device.
...
<Frame>
  ![Miru UI screenshot](https://assets.mirurobotics.com/docs/v03/images/devices/editor/modifications.png)
</Frame>
