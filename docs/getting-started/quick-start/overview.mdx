...
<Tip>
  If you don't already use a schema, we recommend starting with an [empty schema](/cfg-mgmt/schemas/overview#empty-schemas) — one that treats all config instances as valid.
</Tip>
