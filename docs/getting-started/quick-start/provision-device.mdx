...
This getting started guide demonstrates the [dashboard](/fundamentals/devices/provision/dashboard). However, you can also use [provisioning tokens](/fundamentals/devices/provision/provisioning-tokens) to provision devices programmatically.
