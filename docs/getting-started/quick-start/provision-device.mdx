...
This getting started guide demonstrates the [dashboard](/cfg-mgmt/provision-devices/dashboard). However, you can also use [provisioning tokens](/cfg-mgmt/provision-devices/provisioning-tokens) to provision devices programmatically, or the [Ansible](/cfg-mgmt/provision-devices/ansible) collection to install and provision a fleet.
