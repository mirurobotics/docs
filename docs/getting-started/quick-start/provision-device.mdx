...
This getting started guide demonstrates the [dashboard](/essentials/devices/provision/dashboard). However, you can also use [provisioning tokens](/essentials/devices/provision/provisioning-tokens) to provision devices programmatically.
