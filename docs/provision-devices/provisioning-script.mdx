...
The provisioning script is a legacy method for provisioning devices. The provisioning script only supports installing `miru-agent` versions that *precede* `v0.9.0`. To install Miru Agent `v0.9.0` or later, please use a different [provisioning method](/provision-devices/overview).
...
<Danger>
    The provisioning script is a legacy method that only supports installing versions that precede `v0.9.0`. If installing Miru Agent `v0.9.0` or later, please use a different [method](/provision-devices/overview).
</Danger>
