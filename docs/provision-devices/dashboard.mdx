...
The Miru dashboard is the simplest method for provisioning a device, ideal for getting started or managing individual devices. For automated provisioning, use [provisioning tokens](/provision-devices/provisioning-tokens) or the [Ansible](/provision-devices/ansible) collection.
