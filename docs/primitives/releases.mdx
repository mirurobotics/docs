...
<ParamField path="file rules" type="[] File Rule">
  ...
  The [file rules](/data-uploads/primitives/file-rules/overview#properties) that are part of this release.
...
Releases are created via the CLI — visit the config management [create a release](/cfg-mgmt/create-a-release) guide. To add [file rules](/data-uploads/primitives/file-rules/overview) to a release, visit the data uploads [define file rules](/data-uploads/define-file-rules) guide.
