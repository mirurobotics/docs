...
<ParamField path="config schemas" type="[] Config Schema">
  ...
  The [config schemas](/cfg-mgmt/schemas/overview#properties) that define compatible config instances for the release.
...
<ParamField path="upload rules" type="[] Upload Rule">
  ...
  The [upload rules](/data-uploads/upload-rules#properties) that are part of this release.
...
If you want to add [upload rules](/data-uploads/upload-rules) to your release, visit the data uploads [create a release](/data-uploads/create-a-release) guide.
