...
If you want to add [upload rules](/data-uploads/primitives/upload-rules) to your release, visit the data uploads [create a release](/data-uploads/create-a-release) guide.
