...
Members can be granted access to specific groups in the workspace to limit their access to only the resources they need. For more information on group roles and how to use them, visit the user [access control](/admin/users/access-control) documentation.
