...
<Framed image="/images/config-types/header:page.png" background="/images/config-types/background.jpeg" borderWidth="24px 0 0 32px" innerRadius="8px 0 0 0" />
...
<Frame>
  ![Miru UI screenshot](/images/config-types/create-page.png)
</Frame>

Fill in the fields, then click **Create**.

<Frame>
  ![Miru UI screenshot](/images/config-types/create-dialog.png)
</Frame>
...
<Frame>
  ![Miru UI screenshot](/images/config-types/ellipses-dropdown.png)
</Frame>

Update the desired fields, then click **Save**.

<Frame>
  ![Miru UI screenshot](/images/config-types/edit-dialog.png)
</Frame>
...
<Frame>
  ![Miru UI screenshot](/images/config-types/delete-dialog.png)
</Frame>
