...
<Frame>
  ![Create Config Type Page](/images/config-types/create-page.png)
</Frame>
...
Navigate to the [Config Types page](https://app.mirurobotics.com/configs), and click the ellipses (...) on the config type you want to edit, and hit **Edit**.

<Frame>
  ![Config Type Ellipses Dropdown](/images/config-types/ellipses-dropdown.png)
</Frame>

Update the desired fields, then click **Save**.

<Frame>
  ![Edit Config Type Dialog](/images/config-types/edit-dialog.png)
</Frame>
...
<Frame>
  ![Delete Config Type Dialog](/images/config-types/delete-dialog.png)
</Frame>
