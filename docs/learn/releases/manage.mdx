...
<Frame>
  ![Miru UI screenshot](/images/releases/overview.png)
</Frame>
...
<Frame>
  ![Miru UI screenshot](/images/releases/ellipses-dropdown.png)
</Frame>

A dialog will appear—input the new version name and hit **Create**.

<Frame>
  ![Miru UI screenshot](/images/releases/duplicate-dialog.png)
</Frame>
...
<Frame>
  ![Miru UI screenshot](/images/releases/delete-dialog.png)
</Frame>
