...
<Frame>
  ![Miru UI screenshot](https://assets.mirurobotics.com/docs/v03/images/releases/ellipses-dropdown.png)
</Frame>

A dialog will appear—input the new version name and hit **Create**.

<Frame>
  ![Miru UI screenshot](https://assets.mirurobotics.com/docs/v03/images/releases/duplicate-dialog.png)
</Frame>
...
<Frame>
  ![Miru UI screenshot](https://assets.mirurobotics.com/docs/v03/images/releases/delete-dialog.png)
</Frame>
