...
<Frame>
  ![Miru UI screenshot](/images/releases/page.png)
</Frame>

Then select the **Stage** tab at the top of the page.

<Frame>
  ![Miru UI screenshot](/images/releases/stage/page.png)
</Frame>
...
<Frame>
  ![Miru UI screenshot](/images/deployments/staged-panel.png)
</Frame>
...
<Frame>
  ![Miru UI screenshot](/images/deployments/staged-panel:configurations.png)
</Frame>
...
<Tabs>
  <Tab title="Content">
    <Frame>
      ![Miru UI screenshot](/images/config-instances/panel-content:staged.png)
    </Frame>
  </Tab>
  <Tab title="Metadata">
    <Frame>
      ![Miru UI screenshot](/images/config-instances/panel-metadata:staged.png)
    </Frame>
  </Tab>
</Tabs>
...
<Frame>
    ![](/images/releases/stage/patch-dropdown.png)
</Frame>
...
<Frame>
  ![](/images/releases/stage/release-editor-patch.png)
</Frame>
...
<Frame>
  ![Miru UI screenshot](/images/releases/stage/ellipses-dropdown:staged.png)
</Frame>

A confirmation dialog will appear—hit **Archive** to confirm.

<Frame>
  ![Miru UI screenshot](/images/releases/stage/archive-dialog:single.png)
</Frame>
...
<Frame>
  ![Miru UI screenshot](/images/releases/stage/select-devices.png)
</Frame>

At the bottom of the page, click **Archive** from the available bulk actions.

<Frame>
  ![Miru UI screenshot](/images/releases/stage/bulk-actions.png)
</Frame>

A confirmation dialog will appear—hit **Archive** to confirm.

<Frame>
  ![Miru UI screenshot](/images/releases/stage/archive-dialog:bulk.png)
</Frame>
...
<Frame>
  ![Miru UI screenshot](/images/releases/stage/deploy-dialog:bulk.png)
</Frame>
...
![Miru UI screenshot](/images/deployments/deployment-drift.png)
...
<Frame>
  ![Miru UI screenshot](/images/releases/stage/ellipses-dropdown:drifted.png)
</Frame>
...
<Frame>
  ![Miru UI screenshot](/images/releases/stage/review-dialog:deployments.png)
</Frame>

Clicking a deployment opens the deployment details panel on the right side of the page.

<Frame>
  ![Miru UI screenshot](/images/releases/stage/deployment-panel:deployed.png)
</Frame>
...
<Frame>
  ![Miru UI screenshot](/images/releases/stage/config-panel.png)
</Frame>
...
<Frame>
  ![Miru UI screenshot](/images/releases/stage/review-dialog:restage.png)
</Frame>
...
<Frame>
  ![Miru UI screenshot](/images/releases/stage/review-dialog:archive.png)
</Frame>
