...
<Framed background="/images/releases/background.jpeg" image="/images/releases/stage/header:page.png" borderWidth="30px 0 0 48px" innerRadius="8px 0 0 0" />
...
<Frame>
  ![Staging Area Page](/images/releases/stage/page.png)
</Frame>
...
<Frame>
  ![](/images/releases/stage/empty-staging.png)
</Frame>
...
<Frame>
  ![](/images/releases/stage/select-device.png)
</Frame>
...
<Frame>
  ![](/images/releases/stage/release-editor-tooltip.png)
</Frame>
...
<Frame>
  ![](/images/releases/stage/stage-button.png)
</Frame>
...
<Frame>
  ![](/images/releases/stage/stage-dialog.png)
</Frame>
...
<Frame>
  ![](/images/releases/stage/staged-deployment.png)
</Frame>
...
<Frame>
  ![Staged Deployment Panel](/images/deployments/staged-panel.png)
</Frame>
...
<Frame>
  ![Staged Deployment Configurations](/images/deployments/staged-panel:configurations.png)
</Frame>
...
<Tabs>
  <Tab title="Content">
    <Frame>
      ![Staged Deployment Content](/images/config-instances/panel-content:staged.png)
    </Frame>
  </Tab>
  <Tab title="Metadata">
    <Frame>
      ![Staged Deployment Metadata](/images/config-instances/panel-metadata:staged.png)
    </Frame>
  </Tab>
</Tabs>
...
<Frame>
    ![Patch Deployment Dropdown](/images/releases/stage/patch-dropdown.png)
</Frame>
...
<Frame>
  ![Patch Deployment Editor](/images/releases/stage/release-editor-patch.png)
</Frame>
...
<Frame>
  ![Staged Deployment Ellipses Dropdown](/images/releases/stage/ellipses-dropdown:staged.png)
</Frame>

A confirmation dialog will appear—hit **Archive** to confirm.

<Frame>
  ![Archive Staged Deployment Dialog](/images/releases/stage/archive-dialog:single.png)
</Frame>
...
<Frame>
  ![Select Deployments](/images/releases/stage/select-devices.png)
</Frame>

At the bottom of the page, click **Archive** from the available bulk actions.

<Frame>
  ![Bulk Actions](/images/releases/stage/bulk-actions.png)
</Frame>

A confirmation dialog will appear—hit **Archive** to confirm.

<Frame>
  ![Archive Bulk Deployments Dialog](/images/releases/stage/archive-dialog:bulk.png)
</Frame>
...
<Frame>
  ![Deploy Bulk Deployments Dialog](/images/releases/stage/deploy-dialog:bulk.png)
</Frame>
...
![Deployment Drift](/images/deployments/deployment-drift.png)
...
<Frame>
  ![Drifted Deployment Ellipses Dropdown](/images/releases/stage/ellipses-dropdown:drifted.png)
</Frame>
...
<Frame>
  ![Review Deployments Dialog](/images/releases/stage/review-dialog:deployments.png)
</Frame>

Clicking a deployment opens the deployment details panel on the right side of the page.

<Frame>
  ![Review Deployment Panel](/images/releases/stage/deployment-panel:deployed.png)
</Frame>
...
<Frame>
  ![Review Deployment Config Panel](/images/releases/stage/config-panel.png)
</Frame>
...
<Frame>
  ![Review Restage Dialog](/images/releases/stage/review-dialog:restage.png)
</Frame>
...
<Frame>
  ![Review Archive Dialog](/images/releases/stage/review-dialog:archive.png)
</Frame>
