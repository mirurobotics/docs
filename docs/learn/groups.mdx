...
<ParamField path="devices" type="[]Device">
  ...
  Whether the group contains any devices. Computed by the server—useful for determining whether to display device-related affordances in the UI.
</ParamField>

<ParamField path="subgroups" type="[]Group">
  <EditableBadge />

  Whether the group has any child subgroups. Computed by the server—useful for rendering expand/collapse indicators in a tree view.
</ParamField>
...
<Frame>
  ![Group Page](/images/groups/page.png)
</Frame>

Fill in the fields, then click **Create**.

<Frame>
  ![Create Group Dialog](/images/groups/create-dialog.png)
</Frame>

## Edit a group

Navigate to the [Groups page](https://app.mirurobotics.com/groups), click the ellipses (...) on the group you want to edit, and hit **Edit**.

<Frame>
  ![Group Ellipses Dropdown](/images/groups/ellipses-dropdown.png)
</Frame>

Update the desired fields, then click **Save**.

<Frame>
  ![Edit Group Dialog](/images/groups/edit-dialog.png)
</Frame>
...
<Frame>
  ![Delete Group Dialog](/images/groups/delete-dialog.png)
</Frame>
