...
<Framed background="/images/config-schemas/background.png" image="/images/config-schemas/header:panel.png" borderWidth={"32px 56px 0 0"} innerRadius={"0 8px 0 0"} />
...
<Frame>
  ![Invalid Mobility Edit](/images/devices/editor/invalid-mobility-edit.png)
</Frame>
...
<Frame>
  ![Invalid Mobility Error Message](/images/devices/editor/invalid-mobility-err-msg.png)
</Frame>
...
<Frame>
  ![Valid Mobility Edit](/images/devices/editor/valid-mobility-edit.png)
</Frame>
