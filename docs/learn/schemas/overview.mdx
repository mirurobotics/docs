...
<ParamField path="language" type="string">
  ...
  The [schema language](/learn/schemas/languages/overview) used to define the schema.
...
<ParamField path="config type" type="Config Type">
  ...
  The [config type](/learn/config-types#properties) to which the schema belongs.
...
For more information on schema languages, visit the [languages](/learn/schemas/languages/overview) section of this guide.
