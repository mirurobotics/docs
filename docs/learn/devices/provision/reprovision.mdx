...
Reprovisioning is NOT meant to be used to upgrade the `miru-agent` package. If you simply want to upgrade the `miru-agent` package, follow the Miru Agent [upgrade documentation](/docs/developers/agent/upgrade).
