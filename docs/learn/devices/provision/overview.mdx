...
3. [API keys](/learn/devices/provision/api-keys) - the legacy method for programmatically provisioning devices; unsupported with Miru Agent [v0.9.0](/changelog/agent) or later.
