...
API keys are a legacy method for [provisioning](/docs/learn/devices/provision/overview) devices. API keys only support installing `miru-agent` versions that *precede* [v0.9.0](/docs/changelogs/agent). 
