...
First, install the `miru-agent` package on the device. If the `miru-agent` package is already installed, you can skip this step. You can read more about installing the `miru-agent` package [here](/docs/developers/agent/install).
