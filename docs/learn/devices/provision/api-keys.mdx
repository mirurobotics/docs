...
API keys are a legacy method for [provisioning](/docs/learn/devices/provision/provisioning-tokens) devices. API keys only support installing `miru-agent` versions that *precede* [v0.9.0](/docs/changelogs/agent). 
...
<Warning>
    API keys only support installing `miru-agent` versions that precede [v0.9.0](/docs/changelogs/agent). If installing Miru Agent `v0.9.0` or later, you must use [provisioning tokens](/docs/learn/devices/provision/provisioning-tokens).
</Warning>
