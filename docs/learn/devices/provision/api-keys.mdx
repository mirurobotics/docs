...
API keys are a legacy method for [programmatically provisioning](/docs/learn/devices/provision/provisioning-tokens) devices. API keys only support installing `miru-agent` versions that precede [v0.9.0](/docs/changelogs/cli#v0-9-0). 
...
<Warning>
    API keys only support installing `miru-agent` versions that precede [v0.9.0](/docs/changelogs/cli#v0-9-0). If installing Miru Agent `v0.9.0` or later, please use [provisioning tokens](/docs/learn/devices/provision/provisioning-tokens) to provision devices.
</Warning>
