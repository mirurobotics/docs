...
API keys are a legacy method for [provisioning](/learn/devices/provision/overview) devices. API keys only support installing `miru-agent` versions that *precede* [v0.9.0](/changelog/agent).
...
<Warning>
    API keys only support installing `miru-agent` versions that precede [v0.9.0](/changelog/agent). If installing Miru Agent `v0.9.0` or later, you must use [provisioning tokens](/learn/devices/provision/provisioning-tokens).
</Warning>
