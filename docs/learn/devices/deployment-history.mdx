...
<Framed background="/images/devices/background.jpeg" image="/images/devices/deployments/header:page.png" borderWidth={"24px 30px 0 30px"} innerRadius={"12px 12px 0 0"} outerRadius="14px" />
...
<Frame>
  ![Deployed Panel](/images/deployments/deployed-panel.png)
</Frame>
...
<Frame>
  ![Deployed Panel Configurations](/images/deployments/deployed-panel:configurations.png)
</Frame>
...
<Tabs>
  <Tab title="Content">
    <Frame>
      ![Config Instance Content](/images/config-instances/panel-content:deployed.png)
    </Frame>
  </Tab>
  <Tab title="Metadata">
    <Frame>
      ![Config Instance Metadata](/images/config-instances/panel-metadata:deployed.png)
    </Frame>
  </Tab>
</Tabs>
