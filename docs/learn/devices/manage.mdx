...
<Framed background="/images/devices/background.jpeg" image="/images/devices/header:list2.png" borderWidth={"24px 30px 0 30px"} innerRadius="12px 12px 0 0" outerRadius="14px" />
...
<Frame>
  ![Miru UI screenshot](/images/devices/ellipses-dropdown.png)
</Frame>

Update the desired fields, then click **Save**.

<Frame>
  ![Miru UI screenshot](/images/devices/edit-panel.png)
</Frame>
...
<Frame>
  ![Miru UI screenshot](/images/devices/ping-success.png)
</Frame>
...
<Frame>
  ![Miru UI screenshot](/images/devices/ping-timeout.png)
</Frame>
...
<Frame>
  ![Miru UI screenshot](/images/devices/delete-dialog.png)
</Frame>
