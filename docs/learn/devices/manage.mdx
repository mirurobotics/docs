...
To edit a device programmatically, use the [update device endpoint »](/docs/references/server-side-api/2025-08-01/endpoints/devices/update)
...
To delete a device programmatically, use the [delete device endpoint »](/docs/references/server-side-api/2025-08-01/endpoints/devices/delete)
