...
To edit a device programmatically, use the [update device endpoint »](/docs/references/server-side-api/latest/endpoints/devices/update)
...
To delete a device programmatically, use the [delete device endpoint »](/docs/references/server-side-api/latest/endpoints/devices/delete)
