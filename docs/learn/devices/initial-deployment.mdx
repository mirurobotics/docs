...
<Frame>
  ![](https://assets.mirurobotics.com/docs/v03/images/devices/editor/init-set-release.png)
</Frame>
...
<Info>
For a detailed overview of the editor interface — tabs, toolbar, search, and
more — see the [Config editor](/docs/learn/devices/config-editor) page.
</Info>
...
<Frame>
  ![](https://assets.mirurobotics.com/docs/v03/images/devices/editor/init-deployment.png)
</Frame>
