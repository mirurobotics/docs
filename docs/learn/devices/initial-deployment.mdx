...
<Frame>
  ![Miru UI screenshot](https://assets.mirurobotics.com/docs/v03/images/devices/init-dpl-devices-page.png)
</Frame>

Only devices that have been [provisioned](/docs/learn/devices/provision/overview), but never deployed to, are candidates for an initial deployment.
...
<Frame>
  ![Miru UI screenshot](https://assets.mirurobotics.com/docs/v03/images/devices/editor/set-release.png)
</Frame>
...
<Frame>
  ![Miru UI screenshot](https://assets.mirurobotics.com/docs/v03/images/devices/editor/first-draft.png)
</Frame>
...
<Frame>
  ![Miru UI screenshot](https://assets.mirurobotics.com/docs/v03/images/devices/editor/init-deploy.png)
</Frame>
...
<Frame>
  ![Miru UI screenshot](https://assets.mirurobotics.com/docs/v03/images/devices/editor/init-deployment-history.png)
</Frame>
