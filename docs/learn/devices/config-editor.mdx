...
<Frame>
  ![Miru UI screenshot](https://assets.mirurobotics.com/docs/v03/images/devices/editor/layout-temp.png)
</Frame>
...
<Frame>
  ![Miru UI screenshot](https://assets.mirurobotics.com/docs/v03/images/devices/editor/draft-changelog.png)
</Frame>
...
<Frame>
  ![Miru UI screenshot](https://assets.mirurobotics.com/docs/v03/images/devices/editor/deploy.png)
</Frame>
...
<Frame>
  ![Miru UI screenshot](https://assets.mirurobotics.com/docs/v03/images/devices/editor/history-list.png)
</Frame>
...
<Frame>
  ![Miru UI screenshot](https://assets.mirurobotics.com/docs/v03/images/devices/editor/context-menu.png)
</Frame>
...
- **Diff** — Highlights the differences between the head and base deployments
  ...
  - **Red** — Deleted lines, showing the removed content.
    content.
<Frame>
  ![Miru UI screenshot](https://assets.mirurobotics.com/docs/v03/images/devices/editor/view-modes.png)
</Frame>
...
<Frame>
  ![Miru UI screenshot](https://assets.mirurobotics.com/docs/v03/images/devices/editor/diff-navigation.png)
</Frame>
...
<Frame>
  ![Miru UI screenshot](https://assets.mirurobotics.com/docs/v03/images/devices/editor/base-head.png)
</Frame>
...
<Frame>
  ![Miru UI screenshot](https://assets.mirurobotics.com/docs/v03/images/devices/editor/redeploy.png)
</Frame>
...
<Frame>
  ![Miru UI screenshot](https://assets.mirurobotics.com/docs/v03/images/devices/editor/deployment-alert.png)
</Frame>  
