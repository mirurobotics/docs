...
The only exception to this is when a device is [reprovisioned](/docs/learn/devices/provision/reprovision). During reprovisioning, devices briefly enter the `activating` state before transitioning back to `online`.
