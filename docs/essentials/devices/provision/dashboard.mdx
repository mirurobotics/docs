...
The Miru dashboard is the simplest method for provisioning a device, ideal for getting started or managing individual devices. For automated provisioning, consider using [provisioning tokens](/essentials/devices/provision/provisioning-tokens) instead.
