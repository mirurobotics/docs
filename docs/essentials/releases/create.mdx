...
<Warning>
  For upload rules to take effect, you must grant the Miru Agent the necessary file system permissions. Visit the [file permissions](/data-uploads/file-permissions) page.
</Warning>
